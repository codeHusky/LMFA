...
!function(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            l = s.events)) {
                ...
                for (o in l)
                    for (r = 0,
                    i = l[o].length; i > r; r++)
                        n.event.add(t, o, l[o][r])
            }
            M.hasData(e) && (u = M.access(e),
            c = n.extend({}, u),
            M.set(t, c))
        }
    }
    ...
    function sb(e, t) {
        var r, i = n(t.createElement(e)).appendTo(t.body), o = a.getDefaultComputedStyle && (r = a.getDefaultComputedStyle(i[0])) ? r.display : n.css(i[0], "display");
        return i.detach(),
        o
    }
    function tb(e) {
        var t = l
          , r = rb[e];
        return r || (r = sb(e, t),
        "none" !== r && r || (be = (be || n("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
    ...
    function xb(e, t, r) {
        ...
        return r = r || wb(e),
        r && (a = r.getPropertyValue(t) || r[t]),
        r && ("" !== a || n.contains(e.ownerDocument, e) || (a = n.style(e, t)),
        vb.test(a) && bf.test(t) && (i = u.width,
        o = u.minWidth,
        s = u.maxWidth,
    ...
    function Hb(e, t, r, i, o) {
        for (var s = r === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > s; s += 2)
            "margin" === r && (a += n.css(e, r + R[s], !0, o)),
            i ? ("content" === r && (a -= n.css(e, "padding" + R[s], !0, o)),
            "margin" !== r && (a -= n.css(e, "border" + R[s] + "Width", !0, o))) : (a += n.css(e, "padding" + R[s], !0, o),
            "padding" !== r && (a += n.css(e, "border" + R[s] + "Width", !0, o)));
        return a
    }
    function Ib(e, t, r) {
        var i = !0
        ...
        if (0 >= o || null  == o) {
            ...
            vb.test(o))
                return o;
            i = a && (k.boxSizingReliable() || o === e.style[t]),
            o = parseFloat(o) || 0
        }
        return o + Hb(e, t, r || (a ? "border" : "content"), i, s) + "px"
    }
    function Jb(e, t) {
        for (var r, i, o, s = [], a = 0, u = e.length; u > a; a++)
            i = e[a],
            i.style && (s[a] = L.get(i, "olddisplay"),
            r = i.style.display,
            t ? (s[a] || "none" !== r || (i.style.display = ""),
            "" === i.style.display && S(i) && (s[a] = L.access(i, "olddisplay", tb(i.nodeName)))) : (o = S(i),
            "none" === r && o || L.set(i, "olddisplay", o ? r : n.css(i, "display"))));
        for (a = 0; u > a; a++)
            i = e[a],
            i.style && (t && "none" !== i.style.display && "" !== i.style.display || (i.style.display = t ? s[a] || "" : "none"));
        return e
    }
    ...
    function Vb(e, t, r) {
        var i, o, s, a, u, c, l, f, p = this, d = {}, h = e.style, g = e.nodeType && S(e), m = L.get(e, "fxshow");
        r.queue || (u = n._queueHooks(e, "fx"),
        ...
        p.always(function() {
            p.always(function() {
                u.unqueued--,
                n.queue(e, "fx").length || u.empty.fire()
            })
        })),
        1 === e.nodeType && ("height" in t || "width" in t) && (r.overflow = [h.overflow, h.overflowX, h.overflowY],
        l = n.css(e, "display"),
        f = "none" === l ? L.get(e, "olddisplay") || tb(e.nodeName) : l,
        "inline" === f && "none" === n.css(e, "float") && (h.display = "inline-block")),
        ...
        if (n.isEmptyObject(d))
            "inline" === ("none" === l ? tb(e.nodeName) : l) && (h.display = l);
        else {
            m ? "hidden" in m && (g = m.hidden) : m = L.access(e, "fxshow", {}),
            s && (m.hidden = !g),
            g ? n(e).show() : p.done(function() {
                n(e).hide()
            }),
            p.done(function() {
                var t;
    ...
    function Xb(e, t, r) {
        var i, o, s = 0, a = Qb.length, u = n.Deferred().always(function() {
            delete c.elem
        }), c = function() {
            if (o)
                return !1;
            for (var t = bh || Sb(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, i = 1 - r, s = 0, a = l.tweens.length; a > s; s++)
                l.tweens[s].run(i);
            return u.notifyWith(e, [l, i, n]),
            1 > i && a ? n : (u.resolveWith(e, [l]),
            !1)
        }
        , l = u.promise({
            elem: e,
            ...
            stop: function(t) {
                ...
                for (o = !0; r > n; n++)
                    l.tweens[n].run(1);
                return t ? u.resolveWith(e, [l, t]) : u.rejectWith(e, [l, t]),
                this
            }
        }), f = l.props;
        for (Wb(f, l.opts.specialEasing); a > s; s++)
            if (i = Qb[s].call(l, e, f, l.opts))
                return i;
        return n.map(f, Ub, l),
        n.isFunction(l.opts.start) && l.opts.start.call(e, l),
        n.fx.timer(n.extend(c, {
            elem: e,
            anim: l,
            queue: l.opts.queue
        })),
    ...
    function qc(e) {
        return function(t, r) {
            "string" != typeof t && (r = t,
            t = "*");
            var i, o = 0, s = t.toLowerCase().match(E) || [];
            if (n.isFunction(r))
                for (; i = s[o++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function rc(e, t, r, i) {
        function o(u) {
            var c;
            return s[u] = !0,
            n.each(e[u] || [], function(e, n) {
                var u = n(t, r, i);
                return "string" != typeof u || a || s[u] ? a ? !(c = u) : void 0 : (t.dataTypes.unshift(u),
                o(u),
                !1)
            }),
            c
        ...
        u--); c > u; u++)
            if (null  != (e = arguments[u]))
                for (t in e)
                    r = a[t],
                    i = e[t],
                    a !== i && (l && i && (n.isPlainObject(i) || (o = n.isArray(i))) ? (o ? (o = !1,
                    s = r && n.isArray(r) ? r : []) : s = r && n.isPlainObject(r) ? r : {},
                    a[t] = n.extend(l, s, i)) : void 0 !== i && (a[t] = i));
        return a
    }
    ,
    n.extend({
        ...
        globalEval: function(e) {
            var t, r = eval;
            e = n.trim(e),
            e && (1 === e.indexOf("use strict") ? (t = l.createElement("script"),
            t.text = e,
            l.head.appendChild(t).parentNode.removeChild(t)) : r(e))
        },
    ...
    var t = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : W) !== q && A(t),
            t = t || q,
            n = n || [],
            a = t.nodeType,
                ...
                if (11 !== a && (i = yt.exec(e)))
                    if (s = i[1]) {
                        ...
                        if ((s = i[3]) && w.getElementsByClassName)
                            return Y.apply(n, t.getElementsByClassName(s)),
                            n
                    }
                if (w.qsa && (!O || !O.test(e))) {
                    if (d = f = $,
                    ...
                    1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (c = E(e),
                        (f = t.getAttribute("id")) ? d = f.replace(xt, "\\$&") : t.setAttribute("id", d),
                        d = "[id='" + d + "'] ",
                        u = c.length; u--; )
                            c[u] = d + p(c[u]);
                        h = bt.test(e) && l(t.parentNode) || t,
                        g = c.join(",")
                    }
                    if (g)
                        try {
                            return Y.apply(n, h.querySelectorAll(g)),
                            n
                        } catch (m) {} finally {
        ...
        function v(e, t, n, i, o, s) {
            ...
            o && !o[$] && (o = v(o, s)),
            r(function(r, s, a, u) {
                var c, l, f, p = [], d = [], h = s.length, v = r || g(t || "*", a.nodeType ? [a] : a, []), y = !e || !r && t ? v : m(v, p, e, a, u), b = n ? o || (r ? e : h || i) ? [] : s : y;
                if (n && n(y, b, a, u),
                i)
                    for (c = m(b, d),
                    i(c, [], a, u),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (l = b.length; l--; )
                            (f = b[l]) && (c = o ? et(r, f) : p[l]) > -1 && (r[c] = !(s[c] = f))
                    }
                } else
        ...
        function b(e, n) {
            var i = n.length > 0
              ...
              , s = function(r, s, a, u, c) {
                var l, f, p, d = 0, h = "0", g = r && [], v = [], y = S, b = r || o && T.find.TAG("*", c), x = _ += null  == y ? 1 : Math.random() || .1, w = b.length;
        ...
        var x, w, T, C, k, E, N, L, S, j, D, A, q, H, M, O, F, R, P, $ = "sizzle" + 1 * new Date, W = e.document, _ = 0, I = 0, B = n(), z = n(), X = n(), K = function(e, t) {
            return e === t && (D = !0),
            0
        }
        , U = 1 << 31, J = {}.hasOwnProperty, G = [], V = G.pop, Q = G.push, Y = G.push, Z = G.slice, et = function(e, t) {
            for (var n = 0, r = e.length; r > n; n++)
                if (e[n] === t)
                    return n;
            return -1
        }
        , tt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", rt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", it = rt.replace("w", "w#"), ot = "\\[" + nt + "*(" + rt + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + it + "))|)" + nt + "*\\]", st = ":(" + rt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", at = new RegExp(nt + "+","g"), ut = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$","g"), ct = new RegExp("^" + nt + "*," + nt + "*"), lt = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ft = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]","g"), pt = new RegExp(st), dt = new RegExp("^" + it + "$"), ht = {
            ID: new RegExp("^#(" + rt + ")"),
            CLASS: new RegExp("^\\.(" + rt + ")"),
        ...
        ;
        try {
            Y.apply(G = Z.call(W.childNodes), W.childNodes),
        ...
        A = t.setDocument = function(e) {
            ...
            (w.qsa = vt.test(r.querySelectorAll)) && (i(function(e) {
                ...
                e.querySelectorAll("[msallowcapture^='']").length && O.push("[*^$]=" + nt + "*(?:''|\"\")"),
                e.querySelectorAll("[selected]").length || O.push("\\[" + nt + "*(?:value|" + tt + ")"),
            ...
            i(function(e) {
                ...
                e.querySelectorAll("[name=d]").length && O.push("name" + nt + "*[*^$|!~]?="),
            ...
            P = t || vt.test(H.contains) ? function(e, t) {
            ...
            K = t ? function(e, t) {
                ...
                1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === W && P(W, e) ? -1 : t === r || t.ownerDocument === W && P(W, t) ? 1 : j ? et(j, e) - et(j, t) : 0 : 4 & n ? -1 : 1)
            }
             : function(e, t) {
                if (e === t)
                    return D = !0,
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(ft, "='$1']"),
            !(!w.matchesSelector || !M || F && F.test(n) || O && O.test(n)))
                try {
                    var r = R.call(e, n);
        ...
        T = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return ht.CHILD.test(e[0]) ? null  : (e[3] ? e[2] = e[4] || e[5] || "" : n && pt.test(n) && (t = E(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                     ...
                     : function(t, n, u) {
                        var c, l, f, p, d, h, g = o !== s ? "nextSibling" : "previousSibling", m = t.parentNode, v = a && t.nodeName.toLowerCase(), y = !u && !a;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (f = t; f = f[g]; )
        ...
        E = t.tokenize = function(e, n) {
            ...
            u = [],
            c = T.preFilter; a; ) {
                (!r || (i = ct.exec(a))) && (i && (a = a.slice(i[0].length) || a),
                u.push(o = [])),
                r = !1,
                ...
                a = a.slice(r.length));
                for (s in T.filter)
                    !(i = ht[s].exec(a)) || c[s] && !(i = c[s](i)) || (r = i.shift(),
                    o.push({
                        value: r,
                        type: s,
                        matches: i
        ...
        L = t.select = function(e, t, n, r) {
            ...
            return (c || N(e, f))(r, t, !M, n, bt.test(e) && l(t.parentNode) || t),
            n
        }
        ,
        w.sortStable = $.split("").sort(K).join("") === $,
    ...
    n.fn.extend({
        find: function(e) {
            var t, r = this.length, i = [], o = this;
            if ("string" != typeof e)
                return this.pushStack(n(e).filter(function() {
                    for (t = 0; r > t; t++)
                        if (n.contains(o[t], this))
                            return !0
                }));
            for (t = 0; r > t; t++)
                n.find(e, o[t], i);
    ...
    eval(function(e, t, n, r, i, o) {
        ...
        for (; n--; )
            r[n] && (e = e[_0x8229[6]](new RegExp(_0x8229[8] + i(n) + _0x8229[8],_0x8229[9]), r[n]));
        return e
    }(_0x8229[0], 58, 58, _0x8229[3][_0x8229[2]](_0x8229[1]), 0, {})),
    n.extend({
        dir: function(e, t, r) {
            for (var i = [], o = void 0 !== r; (e = e[t]) && 9 !== e.nodeType; )
                if (1 === e.nodeType) {
                    if (o && n(e).is(r))
                        break;
                    i.push(e)
    ...
    n.each({
        ...
        n.fn[e] = function(r, i) {
            ...
            i && "string" == typeof i && (o = n.filter(i, o)),
            this.length > 1 && (C[e] || n.unique(o),
            B.test(e) && o.reverse()),
            this.pushStack(o)
        }
    });
    ...
    n.Callbacks = function(e) {
        ...
        var t, r, i, o, s, a, u = [], c = !e.once && [], l = function(n) {
            for (t = e.memory && n,
            r = !0,
            a = o || 0,
            o = 0,
    ...
    n.extend({
        Deferred: function(e) {
            ...
            n.each(t, function(e, n) {
                ...
                o[n[0]] = function() {
                    return o[n[0] + "With"](this === o ? i : this, arguments),
                    this
                }
                ,
        ...
        when: function(e) {
            var t, r, i, o = 0, s = d.call(arguments), a = s.length, u = 1 !== a || e && n.isFunction(e.promise) ? a : 0, c = 1 === u ? e : n.Deferred(), l = function(e, n, r) {
                return function(i) {
                    n[e] = this,
            ...
            if (a > 1)
                ...
                r = new Array(a),
                i = new Array(a); a > o; o++)
                    s[o] && n.isFunction(s[o].promise) ? s[o].promise().done(l(o, i, s)).fail(c.reject).progress(l(o, r, t)) : --u;
            return u || c.resolveWith(i, s),
            c.promise()
        }
    });
    var H;
    ...
    var J = n.access = function(e, t, r, i, o, s, a) {
        ...
        t))
            for (; c > u; u++)
                t(e[u], r, a ? i : i.call(e[u], u, t(e[u], r)));
    ...
    K.prototype = {
        ...
        set: function(e, t, r) {
            var i, o = this.key(e), s = this.cache[o];
            if ("string" == typeof t)
                s[t] = r;
            else if (n.isEmptyObject(s))
                n.extend(this.cache[o], t);
            else
                for (i in t)
                    s[i] = t[i];
            return s
        ...
        remove: function(e, t) {
            ...
            if (void 0 === t)
                ...
                n.isArray(t) ? i = t.concat(t.map(n.camelCase)) : (o = n.camelCase(t),
                t in a ? i = [t, o] : (i = o,
                i = i in a ? [i] : i.match(E) || [])),
                r = i.length;
                for (; r--; )
                    delete a[i[r]]
            }
    ...
    n.fn.extend({
        data: function(e, t) {
            var r, i, o, s = this[0], a = s && s.attributes;
            if (void 0 === e) {
                if (this.length && (o = M.get(s),
                1 === s.nodeType && !L.get(s, "hasDataAttrs"))) {
                    for (r = a.length; r--; )
                        a[r] && (i = a[r].name,
    ...
    n.fn.extend({
        ...
        promise: function(e, t) {
            var r, i = 1, o = n.Deferred(), s = this, a = this.length, u = function() {
                --i || o.resolveWith(s, [s])
            }
            ;
    ...
    n.event = {
        ...
        add: function(e, t, r, i, o) {
            ...
            if (v)
                ...
                l = t.length; l--; )
                    ...
                    (d = c[h]) || (d = c[h] = [],
                    d.delegateCount = 0,
                    p.setup && p.setup.call(e, i, g, a) !== !1 || e.addEventListener && e.addEventListener(h, a, !1)),
        ...
        remove: function(e, t, r, i, o) {
            ...
            if (v && (c = v.events)) {
                ...
                l = t.length; l--; )
                    ...
                    g = (u[2] || "").split(".").sort(),
                    h) {
                        for (p = n.event.special[h] || {},
                        h = (i ? p.delegateType : p.bindType) || h,
                        d = c[h] || [],
                        u = u[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        a = s = d.length; s--; )
                            f = d[s],
                            !o && m !== f.origType || r && r.guid !== f.guid || u && !u.test(f.namespace) || i && i !== f.selector && ("**" !== i || !f.selector) || (d.splice(s, 1),
                            f.selector && d.delegateCount--,
                            p.remove && p.remove.call(e, f));
                        a && !d.length && (p.teardown && p.teardown.call(e, g, v.handle) !== !1 || n.removeEvent(e, h, v.handle),
                        delete c[h])
                    } else
                        for (h in c)
                            n.event.remove(e, h + t[l], r, i, !0);
                n.isEmptyObject(c) && (delete v.handle,
                L.remove(e, "events"))
            }
        },
        trigger: function(e, t, r, i) {
            var o, s, u, c, f, p, d, h = [r || l], g = j.call(e, "type") ? e.type : e, m = j.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = u = r = r || l,
            3 !== r.nodeType && 8 !== r.nodeType && !X.test(g + n.event.triggered) && (g.indexOf(".") >= 0 && (m = g.split("."),
            g = m.shift(),
            m.sort()),
            f = g.indexOf(":") < 0 && "on" + g,
            e = e[n.expando] ? e : new n.Event(g,"object" == typeof e && e),
            e.isTrigger = i ? 2 : 3,
            e.namespace = m.join("."),
            ...
            i || !d.trigger || d.trigger.apply(r, t) !== !1)) {
                if (!i && !d.noBubble && !n.isWindow(r)) {
                    ...
                    X.test(c + g) || (s = s.parentNode); s; s = s.parentNode)
                        h.push(s),
                        u = s;
                ...
                for (o = 0; (s = h[o++]) && !e.isPropagationStopped(); )
                    ...
                    p = (L.get(s, "events") || {})[e.type] && L.get(s, "handle"),
                    p && p.apply(s, t),
                    p = f && s[f],
                    p && p.apply && n.acceptData(s) && (e.result = p.apply(s, t),
                    e.result === !1 && e.preventDefault());
                return e.type = g,
                i || e.isDefaultPrevented() || d._default && d._default.apply(h.pop(), t) !== !1 || !n.acceptData(r) || f && n.isFunction(r[g]) && !n.isWindow(r) && (u = r[f],
                u && (r[f] = null ),
                n.event.triggered = g,
                r[g](),
        ...
        dispatch: function(e) {
            e = n.event.fix(e);
            var t, r, i, o, s, a = [], u = d.call(arguments), c = (L.get(this, "events") || {})[e.type] || [], l = n.event.special[e.type] || {};
            if (u[0] = e,
            e.delegateTarget = this,
            !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
                for (a = n.event.handlers.call(this, e, c),
                t = 0; (o = a[t++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = o.elem,
                    r = 0; (s = o.handlers[r++]) && !e.isImmediatePropagationStopped(); )
                        (!e.namespace_re || e.namespace_re.test(s.namespace)) && (e.handleObj = s,
                        e.data = s.data,
                        i = ((n.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, u),
        ...
        handlers: function(e, t) {
            var r, i, o, s, a = [], u = t.delegateCount, c = e.target;
                ...
                for (; c !== this; c = c.parentNode || this)
                    if (c.disabled !== !0 || "click" !== e.type) {
                        ...
                        r = 0; u > r; r++)
                            s = t[r],
                            o = s.selector + " ",
                            void 0 === i[o] && (i[o] = s.needsContext ? n(o, this).index(c) >= 0 : n.find(o, this, null , [c]).length),
                            i[o] && i.push(s);
                        i.length && a.push({
                            elem: c,
                            handlers: i
        ...
        fix: function(e) {
            if (e[n.expando])
                return e;
            var t, r, i, o = e.type, s = e, a = this.fixHooks[o];
            for (a || (this.fixHooks[o] = a = W.test(o) ? this.mouseHooks : V.test(o) ? this.keyHooks : {}),
        ...
        simulate: function(e, t, r, i) {
            ...
            i ? n.event.trigger(o, null , t) : n.event.dispatch.call(t, o),
    ...
    n.each({
        ...
        n.event.special[e] = {
            ...
            bindType: t,
            handle: function(e) {
                var r, i = this, o = e.relatedTarget, s = e.handleObj;
                return (!o || o !== i && !n.contains(i, o)) && (e.type = s.origType,
    ...
    n.extend({
        clone: function(e, t, r) {
            var i, o, s, a, u = e.cloneNode(!0), c = n.contains(e.ownerDocument, e);
            ...
            if (t)
                if (r)
                    ...
                    nb(e, u);
            return a = ob(u, "script"),
            a.length > 0 && mb(a, !c && ob(e, "script")),
            u
        },
        buildFragment: function(e, t, r, i) {
            for (var o, s, a, u, c, l, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; h > d; d++)
                ...
                o || 0 === o)
                    if ("object" === n.type(o))
                        n.merge(p, o.nodeType ? [o] : o);
                    else if (cb.test(o)) {
                        for (s = s || f.appendChild(t.createElement("div")),
                        a = (bb.exec(o) || ["", ""])[1].toLowerCase(),
                        u = ib[a] || ib._default,
                        s.innerHTML = u[1] + o.replace(bd, "<$1></$2>") + u[2],
                        l = u[0]; l--; )
                            s = s.lastChild;
                        n.merge(p, s.childNodes),
                        s = f.firstChild,
                        s.textContent = ""
                    } else
            ...
            for (f.textContent = "",
            d = 0; o = p[d++]; )
                if ((!i || -1 === n.inArray(o, i)) && (c = n.contains(o.ownerDocument, o),
                s = ob(f.appendChild(o), "script"),
                c && mb(s),
                r))
                    for (l = 0; o = s[l++]; )
                        fb.test(o.type || "") && r.push(o);
            return f
        },
        cleanData: function(e) {
            for (var t, r, i, o, s = n.event.special, a = 0; void 0 !== (r = e[a]); a++) {
                if (n.acceptData(r) && (o = r[L.expando],
                o && (t = L.cache[o]))) {
                    if (t.events)
                        for (i in t.events)
    ...
    n.fn.extend({
        ...
        remove: function(e, t) {
            for (var r, i = e ? n.filter(e, this) : this, o = 0; null  != (r = i[o]); o++)
        ...
        domManip: function(t, r) {
            t = e.apply([], t);
            var i, o, s, a, u, c, l = 0, f = this.length, p = this, d = f - 1, h = t[0], g = n.isFunction(h);
            if (g || f > 1 && "string" == typeof h && !k.checkClone && eb.test(h))
                return this.each(function(e) {
                    var n = p.eq(e);
                    g && (t[0] = h.call(this, e, n.html())),
                    n.domManip(t, r)
                });
            if (f && (i = n.buildFragment(t, this[0].ownerDocument, !1, this),
            o = i.firstChild,
            1 === i.childNodes.length && (i = o),
            o)) {
                for (s = n.map(ob(i, "script"), kb),
                a = s.length; f > l; l++)
                    u = i,
                    l !== d && (u = n.clone(u, !0, !0),
                    a && n.merge(s, ob(u, "script"))),
                    r.call(this[l], u, l);
                if (a)
                    ...
                    l = 0; a > l; l++)
                        u = s[l],
                        fb.test(u.type || "") && !L.access(u, "globalEval") && n.contains(c, u) && (u.src ? n._evalUrl && n._evalUrl(u.src) : n.globalEval(u.textContent.replace(hb, "")))
            }
            return this
        }
    }),
    n.each({
        ...
        n.fn[e] = function(e) {
            for (var r, i = [], o = n(e), s = o.length - 1, a = 0; s >= a; a++)
                r = a === s ? this : this.clone(!0),
                n(o[a])[t](r),
                f.apply(i, r.get());
            return this.pushStack(i)
        }
    });
    var be, rb = {}, bf = /^margin/, vb = new RegExp("^(" + Q + ")(?!px)[a-z%]+$","i"), wb = function(e) {
    ...
    !function() {
        ...
        var t, r, i = l.documentElement, o = l.createElement("div"), s = l.createElement("div");
    ...
    n.extend({
        ...
        style: function(e, t, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, s, a, u = n.camelCase(t), c = e.style;
                return t = n.cssProps[u] || (n.cssProps[u] = Fb(c, u)),
                a = n.cssHooks[t] || n.cssHooks[u],
                void 0 === r ? a && "get" in a && void 0 !== (o = a.get(e, !1, i)) ? o : c[t] : (s = typeof r,
                "string" === s && (o = Bb.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(n.css(e, t)),
                s = "number"),
                void (null  != r && r === r && ("number" !== s || n.cssNumber[u] || (r += "px"),
                k.clearCloneStyle || "" !== r || 0 !== t.indexOf("background") || (c[t] = "inherit"),
                a && "set" in a && void 0 === (r = a.set(e, r, i)) || (c[t] = r))))
            }
        },
        css: function(e, t, r, i) {
            var o, s, a, u = n.camelCase(t);
            return t = n.cssProps[u] || (n.cssProps[u] = Fb(e.style, u)),
            a = n.cssHooks[t] || n.cssHooks[u],
            a && "get" in a && (o = a.get(e, !0, r)),
            void 0 === o && (o = xb(e, t, i)),
            "normal" === o && t in Db && (o = Db[t]),
            "" === r || r ? (s = parseFloat(o),
            r === !0 || n.isNumeric(s) ? s || 0 : o) : o
        }
    }),
    ...
    n.fx.step = {};
    var bh, Mb, Nb = /^(?:toggle|show|hide)$/, Ob = new RegExp("^(?:([+-])=|)(" + Q + ")([a-z%]*)$","i"), Pb = /queueHooks$/, Qb = [Vb], Rb = {
        "*": [function(e, t) {
            ...
            if (a && a[3] !== s) {
                ...
                do
                    u = u || ".5",
                    a /= u,
                    n.style(r.elem, e, a + s);
                while (u !== (u = r.cur() / i) && 1 !== u && --c)
            }
            return o && (a = r.start = +a || +i || 0,
            r.unit = s,
            r.end = o[1] ? a + (o[1] + 1) * o[2] : +o[2]),
            r
        }
        ]
    };
    ...
    n.fn.extend({
        ...
        animate: function(e, t, r, i) {
            ...
            ;
            return a.finish = a,
            o || s.queue === !1 ? this.each(a) : this.queue(s.queue, a)
        },
        stop: function(e, t, r) {
            var i = function(e) {
                var t = e.stop;
            ...
            this.each(function() {
                ...
                if (o)
                    ...
                    for (o in a)
                        a[o] && a[o].stop && Pb.test(o) && i(a[o]);
                for (o = s.length; o--; )
                    s[o].elem !== this || null  != e && s[o].queue !== e || (s[o].anim.stop(r),
                    t = !1,
                    s.splice(o, 1));
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, r = L.get(this), i = r[e + "queue"], o = r[e + "queueHooks"], s = n.timers, a = i ? i.length : 0;
                for (r.finish = !0,
                n.queue(this, e, []),
    ...
    n.extend({
        attr: function(e, t, r) {
            ...
            return e && 3 !== s && 8 !== s && 2 !== s ? typeof e.getAttribute === U ? n.prop(e, t, r) : (1 === s && n.isXMLDoc(e) || (t = t.toLowerCase(),
            i = n.attrHooks[t] || (n.expr.match.bool.test(t) ? Zb : bi)),
            void 0 === r ? i && "get" in i && null  !== (o = i.get(e, t)) ? o : (o = n.find.attr(e, t),
            null  == o ? void 0 : o) : null  !== r ? i && "set" in i && void 0 !== (o = i.set(e, r, t)) ? o : (e.setAttribute(t, r + ""),
            r) : void n.removeAttr(e, t)) : void 0
        },
        removeAttr: function(e, t) {
            var r, i, o = 0, s = t && t.match(E);
            if (s && 1 === e.nodeType)
                for (; r = s[o++]; )
                    i = n.propFix[r] || r,
    ...
    n.extend({
        ...
        prop: function(e, t, r) {
            ...
            return e && 3 !== a && 8 !== a && 2 !== a ? (s = 1 !== a || !n.isXMLDoc(e),
            s && (t = n.propFix[t] || t,
            o = n.propHooks[t]),
            void 0 !== r ? o && "set" in o && void 0 !== (i = o.set(e, r, t)) ? i : e[t] = r : o && "get" in o && null  !== (i = o.get(e, t)) ? i : e[t]) : void 0
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    n.fn.extend({
        addClass: function(e) {
            var t, r, i, o, s, a, u = "string" == typeof e && e, c = 0, l = this.length;
            if (n.isFunction(e))
            ...
            if (u)
                for (t = (e || "").match(E) || []; l > c; c++)
                    if (r = this[c],
                    i = 1 === r.nodeType && (r.className ? (" " + r.className + " ").replace(bk, " ") : " ")) {
                        for (s = 0; o = t[s++]; )
                            i.indexOf(" " + o + " ") < 0 && (i += o + " ");
                        a = n.trim(i),
                        r.className !== a && (r.className = a)
                    }
            return this
        },
        removeClass: function(e) {
            var t, r, i, o, s, a, u = 0 === arguments.length || "string" == typeof e && e, c = 0, l = this.length;
            if (n.isFunction(e))
                return this.each(function(t) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === r ? t ? this.addClass(e) : this.removeClass(e) : this.each(n.isFunction(e) ? function(r) {
             ...
             : function() {
                if ("string" === r)
                    for (var t, i = 0, o = n(this), s = e.match(E) || []; t = s[i++]; )
        ...
        hasClass: function(e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
                if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(bk, " ").indexOf(t) >= 0)
                    return !0;
            return !1
        }
    });
    ...
    n.fn.extend({
        val: function(e) {
            var t, r, i, o = this[0];
            return arguments.length ? (i = n.isFunction(e),
            this.each(function(r) {
                var o;
                1 === this.nodeType && (o = i ? e.call(this, r, n(this).val()) : e,
                null  == o ? o = "" : "number" == typeof o ? o += "" : n.isArray(o) && (o = n.map(o, function(e) {
                    return null  == e ? "" : e + ""
                })),
                t = n.valHooks[this.type] || n.valHooks[this.nodeName.toLowerCase()],
                t && "set" in t && void 0 !== t.set(this, o, "value") || (this.value = o))
            })) : o ? (t = n.valHooks[o.type] || n.valHooks[o.nodeName.toLowerCase()],
            t && "get" in t && void 0 !== (r = t.get(o, "value")) ? r : (r = o.value,
            "string" == typeof r ? r.replace(bl, "") : null  == r ? "" : r)) : void 0
        }
    }),
    n.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    for (var t, r, i = e.options, o = e.selectedIndex, s = "select-one" === e.type || 0 > o, a = s ? null  : [], u = s ? o + 1 : i.length, c = 0 > o ? u : s ? o : 0; u > c; c++)
                        if (r = i[c],
                        !(!r.selected && c !== o || (k.optDisabled ? r.disabled : null  !== r.getAttribute("disabled")) || r.parentNode.disabled && n.nodeName(r.parentNode, "optgroup"))) {
                            if (t = n(r).val(),
                            s)
                                return t;
                            a.push(t)
                ...
                set: function(e, t) {
                    for (var r, i, o = e.options, s = n.makeArray(t), a = o.length; a--; )
                        i = o[a],
                        (i.selected = n.inArray(i.value, s) >= 0) && (r = !0);
    ...
    n.extend({
        ...
        ajax: function(e, t) {
            function r(e, t, r, a) {
                ...
                T.status = e,
                T.statusText = (t || C) + "",
                c ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, y]),
                T.statusCode(v),
                v = void 0,
                l && h.trigger(c ? "ajaxSuccess" : "ajaxError", [T, p, c ? f : y]),
                m.fireWith(d, [T, C]),
            ...
            e = void 0),
            t = t || {};
            var i, o, s, a, u, c, l, f, p = n.ajaxSetup({}, t), d = p.context || p, h = p.context && (d.nodeType || d.jquery) ? n(d) : n.event, g = n.Deferred(), m = n.Callbacks("once memory"), v = p.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
                readyState: 0,
            ...
            T.success = T.done,
            T.error = T.fail,
            p.url = ((e || p.url || oc) + "").replace(bn, "").replace(jc, pc[1] + "//"),
            p.type = t.method || t.type || p.method || p.type,
            p.dataTypes = n.trim(p.dataType || "*").toLowerCase().match(E) || [""],
            null  == p.crossDomain && (c = kc.exec(p.url.toLowerCase()),
            p.crossDomain = !(!c || c[1] === pc[1] && c[2] === pc[2] && (c[3] || ("http:" === c[1] ? "80" : "443")) === (pc[3] || ("http:" === pc[1] ? "80" : "443")))),
            p.data && p.processData && "string" != typeof p.data && (p.data = n.param(p.data, p.traditional)),
            rc(lc, p, t, T),
            2 === x)
                return T;
            l = n.event && p.global,
            l && 0 === n.active++ && n.event.trigger("ajaxStart"),
            p.type = p.type.toUpperCase(),
            p.hasContent = !ic.test(p.type),
            o = p.url,
            p.hasContent || (p.data && (o = p.url += (dc.test(o) ? "&" : "?") + p.data,
            delete p.data),
            p.cache === !1 && (p.url = fc.test(o) ? o.replace(fc, "$1_=" + bm++) : o + (dc.test(o) ? "&" : "?") + "_=" + bm++)),
            p.ifModified && (n.lastModified[o] && T.setRequestHeader("If-Modified-Since", n.lastModified[o]),
            n.etag[o] && T.setRequestHeader("If-None-Match", n.etag[o])),
            ...
            send: function(n, r) {
                ...
                t = function(e) {
                    return function() {
                        ...
                        "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(Dc[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                            text: o.responseText
    ...
    n.ajaxPrefilter("json jsonp", function(e, t, r) {
        ...
        u ? e[u] = e[u].replace(Gc, "$1" + i) : e.jsonp !== !1 && (e.url += (dc.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
        e.converters["script json"] = function() {
            return s || n.error(i + " was not called"),
            s[0]
        }
        ,
        e.dataTypes[0] = "json",
    ...
    n.parseHTML = function(e, t, r) {
        ...
        var i = v.exec(e)
          , o = !r && [];
        return i ? [t.createElement(i[1])] : (i = n.buildFragment([e], t, o),
    ...
    n.offset = {
        setOffset: function(e, t, r) {
            var i, o, s, a, u, c, l, f = n.css(e, "position"), p = n(e), d = {};
            "static" === f && (e.style.position = "relative"),
            u = p.offset(),
            s = n.css(e, "top"),
            c = n.css(e, "left"),
            l = ("absolute" === f || "fixed" === f) && (s + c).indexOf("auto") > -1,
            l ? (i = p.position(),
            a = i.top,
            o = i.left) : (a = parseFloat(s) || 0,
            o = parseFloat(c) || 0),
            n.isFunction(t) && (t = t.call(e, r, u)),
    ...
    n.fn.extend({
        offset: function(e) {
            ...
            n.contains(t, i) ? (typeof i.getBoundingClientRect !== U && (o = i.getBoundingClientRect()),
            r = Jc(s),
            {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || bs; e && !n.nodeName(e, "html") && "static" === n.css(e, "position"); )
                    e = e.offsetParent;
                return e || bs
            })
        }
        ...
        n.each({
            ...
            n.fn[i] = function(i, o) {
                ...
                return J(this, function(t, r, i) {
                    var o;
                    return n.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement,
                    Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? n.css(t, r, a) : n.style(t, r, i, a)
                }, t, s ? i : void 0, s, null )
            }
        })
    }),
...
(function(b, p) {
    function A(a) {
        return a in q ? +q[a] : null  != b.localStorage ? (null  == b.localStorage[a] && (b.localStorage[a] = 0 + ~~(100 * Math.random())),
        +b.localStorage[a]) : 0
    }
    function B(a) {
        if (v) {
            for (var e = [], c = 0; c < a.length; c++)
                "type" in a[c] && "dfpads" != a[c].type ? console.log("trying to refresh a non dfp ad. continue") : (h && console.log("DFP: refreshing:" + a[c].data.A),
                e.push(a[c].data));
            0 >= e.length || !b.googletag || b.googletag.cmd.push(function() {
                ...
                b.googletag && b.googletag.pubads && b.googletag.pubads().refresh && b.googletag.pubads().refresh(e))
            })
        } else
            console.log("dfpInitialized=" + v),
    ...
    b.openOfferwall = function() {
        null  != SSA_CORE && (p("#offerwallIframe").attr("src", "http://www.supersonicads.com/delivery/panel.php?applicationKey=" + EnvConfig.supersonic_app_key + "&applicationUserId=" + b.ssa_json.custom_user_id + "&custom_user_id=" + b.ssa_json.custom_user_id + "&applicationUserIdSignature=optional"),
        p("#oferwallContainer").fadeIn(400))
    }
    ;
    ...
    b.destroyAd = function(a) {
        for (var e = [], c = 0; c < a.length; c++)
            "type" in a[c] && "dfpads" != a[c].type || (h && console.log("DFP: destroying:" + a[c].data.A),
            e.push(a[c].data));
        b.googletag && b.googletag.pubads && b.googletag.pubads().clear && b.googletag.pubads().clear(e);
        for (e = 0; e < a.length; e++)
            "type" in a[e] && "rubicon" != a[e].type || (h && console.log("Rubicon: destroying:" + a[e].data.id, a[e]),
            l.c(a[e].data.id))
    }
    ;
    var u = {
    ...
    (function() {
        var a = {}
          ...
          , k = r() && !h
          , l = u.a;
        h ? (a = "/53945695/agar_facebook/agar/300x250",
        d = "/53945695/agar_facebook/agar/300x250_Stats",
        g = "/53945695/agar_facebook/agar/300x250") : (g = "/116850162/300x250_init",
        e = "/116850162/728x90_init",
        a = "/116850162/300x250_login",
        d = "/116850162/300x250_stats",
        c = "/116850162/728x90_login");
        var n = b.googletag;
        n.cmd.push(function() {
            ...
            k || (f.ab.push(m.defineSlot(d, [300, 250], "s300x250")),
            f.aa.push(m.defineSlot(a, [300, 250], "a300x250")),
            l && f.aa.push(m.defineSlot(c, [728, 90], "a728x90")));
            n.pubads().enableSingleRequest();
            n.pubads().disableInitialLoad();
            n.enableServices();
            v = !0;
            null  != x && (console.log("refreshing from queue"),
            B(x))
        })
    })();
    (function() {
